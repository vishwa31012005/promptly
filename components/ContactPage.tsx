...
const ContactPage: React.FC = () => {
  return (
    <div>
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 space-y-6">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Vishwa</h2>
          <p className="text-md text-gray-600 dark:text-gray-400">Final Year Student</p>
        </div>
        ...
        <div className="space-y-4">
          <a 
            ...
            className="flex items-center p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 group"
          >
